...
import 'package:smart_tumour_detector/features/appointment/presentation/view/widgets/appointment_complete_container.dart';

class AppointmentCompletePageBody extends StatelessWidget {
  const AppointmentCompletePageBody({
    super.key,
  });
          ...
          if (state is DoctorLoading) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) => Padding(
                ...
                child: AppointmentCompleteContainer(
