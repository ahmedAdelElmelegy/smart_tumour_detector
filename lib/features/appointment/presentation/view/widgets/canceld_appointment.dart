...
import 'package:smart_tumour_detector/features/appointment/presentation/view/widgets/canceld_appointment_body.dart';

class CanceldAppointment extends StatelessWidget {
  const CanceldAppointment({super.key});
